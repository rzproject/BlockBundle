...
namespace Rz\BlockBundle\Templating\Helper;
...
use Sonata\BlockBundle\Templating\Helper\BlockHelper as BaseBlockHelper;

class BlockHelper extends BaseBlockHelper
{
        ...
        if ($cacheService) {
            ...
            if ($cacheService->has($cacheKeys)) {
                ...
                if (!$cacheElement->isExpired() &&
                    $cacheElement->getData() instanceof Response &&
                    (!$this->securityContext->isGranted('ROLE_SUPER_ADMIN') || !$this->securityContext->isGranted('ROLE_SONATA_ADMIN'))) {
